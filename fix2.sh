#!/bin/bash
set -e
cp /opt/teoria/server.js /opt/teoria/server.js.bak3 2>/dev/null || true
...
echo ""
echo ">>> فحص:"
echo -n "  السيرفر: "; curl -s http://127.0.0.1:3000/siwad/api/state | head -c 30; echo ""
echo -n "  الواتساب: "; curl -s -X POST http://127.0.0.1:3000/api/enter -H "Content-Type: application/json" -d '{"phone":"970500000000","name":"t"}' | head -c 90; echo ""
echo ""
echo "============================================"
echo "  ✅ افتح https://teoriaai.com/siwad"
echo "  (اعمل تحديث قوي: Ctrl+Shift+R)"
echo "============================================"
