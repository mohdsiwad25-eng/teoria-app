#!/bin/bash
set -e
cp /opt/teoria/server.js /opt/teoria/server.js.bak5 2>/dev/null || true
...
sleep 3
pm2 logs teoria --lines 3 --nostream || true
echo "✅ التذكيرات جاهزة — اللوحة > إعدادات > التذكير التلقائي 🔔"
